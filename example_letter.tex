\documentclass[10pt]{deptletter}
\usepackage{hyperref}

%the variables and commands in the deptletter package are prefaced by
%'DL' to reduce ambiguity.

%contact information is placed at the opening of the letter
\DLcontact{
  John Doe\\
  Associate Professor\\
  Department of Megaphysics\\
  University of Georgia}

%website information, if provided, goes just beneath the contact
%information above. the typeface is slightly different
\DLwebsite{http://website.com}
\DLsignature{John Doe}
\DLdate{\today}
\DLfoot{ 
  Department of Megaphysics -- 
  ~University of Georgia -- 
  ~Graduate Studies Research Center Building\\ 
  ~300 West Drive -- 
  ~Athens, GA --
  ~30602}

\DLheaderpic{logo.pdf}
\DLsignaturepic{signature.pdf}

\begin{document}

\DLopening{Dear Colleague,}
